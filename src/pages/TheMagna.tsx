...
const TheMagna = () => {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ["reviews", "the-magna"],
    queryFn: async () => {
      const { data, error } = await supabase.functions.invoke("fetch-reviews", {
        body: { listingId: "6704b3b703f92a001157ed81" },
      });
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-16 px-4 shadow-lg">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">The Magna</h1>
      ...
      {/* Navigation */}
      <PropertyNav currentProperty="the-magna" />
